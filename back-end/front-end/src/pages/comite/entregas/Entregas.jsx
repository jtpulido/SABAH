...
export default function Entregas() {
  ...
  const columns = [
    { field: 'fecha_apertura', headerName: 'Fecha de apertura', flex: 0.2, minWidth: 150, headerAlign: "center" },
    { field: 'fecha_cierre', headerName: 'Fecha de cierre', flex: 0.2, minWidth: 150, headerAlign: "center" },
    { field: 'modalidad', headerName: 'Modalidad', flex: 0.2, minWidth: 100, headerAlign: "center", align: "center" },
    { field: 'etapa', headerName: 'Etapa', flex: 0.2, minWidth: 100, headerAlign: "center", align: "center" },
   {
      ...
      renderCell: ({ row: { id } }) => {
        return (
          <Box width="100%" m="0 auto" p="5px" display="flex" justifyContent="center"          >
            <Tooltip title="Ver Entrega"><IconButton color="secondary" onClick={() => verProyecto(id)}>
              <Visibility />
            </IconButton></Tooltip>
            <Tooltip title="Editar Entrega"><IconButton color="secondary" onClick={() => verProyecto(id)}>
              <Edit />
            </IconButton></Tooltip>
          </Box>
        );
