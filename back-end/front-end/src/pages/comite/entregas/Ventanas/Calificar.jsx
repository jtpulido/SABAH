...
function CalificarEntrega({ open, onClose, onSubmit, entrega = {}, tipo }) {
    ...
    const columnas = [
        { field: 'nombre_aspecto', headerName: 'Nombre del aspecto', flex: 0.3, minWidth: 300 },
        { field: 'puntaje_aspecto', headerName: 'Puntaje', flex: 0.1, minWidth: 150 },
        { field: 'comentario_aspecto', headerName: 'Comentario', flex: 0.6, minWidth: 300 },
    ]
                                        ...
                                        {aspectos.map((aspecto) => (
                                            <Box key={aspecto.id_aspecto}>
                                                <Stack spacing={1} marginBottom={2}>
                                                    <Typography variant="h4" color={colors.secondary[100]}>
