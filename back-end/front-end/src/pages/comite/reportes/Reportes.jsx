...
import { Visibility, Source,Person } from '@mui/icons-material';
...
export default function Proyectos() {
  ...
  const columns = [
    { field: 'tipo', headerName: 'Tipo de reporte', flex: 0.2, minWidth: 150, headerAlign: "center" },
    { field: 'fecha', headerName: 'Fecha de reporte', flex: 0.1, minWidth: 150, headerAlign: "center" },
    { field: 'nombre_director', headerName: 'Nombre del director', flex: 0.2, minWidth: 150, headerAlign: "center" },
    ...
    {
      field: "id", headerName: "Acción", width: 100, flex: 0.1, minWidth: 100, headerAlign: "center", align: "center",
      renderCell: ({ row: { id } }) => {
        return (
          <Box width="100%" m="0 auto" p="5px" display="flex" justifyContent="center"          >
            <Tooltip title="Ver reporte"><IconButton color="secondary" onClick={() => verProyecto(id)}>
              <Visibility />
            </IconButton></Tooltip>
            <Tooltip title="Ver Director"><IconButton color="secondary" onClick={() => verProyecto(id)} >
              <Person />
            </IconButton></Tooltip>
